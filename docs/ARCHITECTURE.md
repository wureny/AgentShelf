...
13. Evaluate rule changes against human labels for true positives and false positives before tightening CI gates.
...
- Add richer label authoring helpers so calibration exports can be promoted into labels with less manual editing.
