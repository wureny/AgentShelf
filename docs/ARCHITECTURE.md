...
- Add schema contract docs and validation warnings for required import fields so agents can fix export pipelines before generated snapshots become misleading.
