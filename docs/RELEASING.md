...
```bash
agentshelf release-check --expected-version 0.35.0
agentshelf release-notes --version 0.35.0 --output /tmp/agentshelf-v0.35.0-release.md
...
Then draft a GitHub release for `v0.35.0` using the generated release notes.
...
- Confirm the copyable Action example uses `wureny/AgentShelf@v0.35.0`.
